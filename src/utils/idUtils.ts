 ...
 * over `getId` if you need to use it as a DOM id.
 *
 * @param prefix Optional. Prefix for the string id.
 * @param length Default: 8. Length of string.
 * @param onlyUpperCase Default: false. No lowercase letters.
 */
export function getStringId(prefix?: string, length = 8, onlyUpperCase = false): string {
